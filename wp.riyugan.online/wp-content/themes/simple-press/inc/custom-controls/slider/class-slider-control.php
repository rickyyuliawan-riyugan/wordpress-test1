...
if ( ! class_exists( 'Simple_Press_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Simple_Press_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'simple-press-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'simple-press-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
